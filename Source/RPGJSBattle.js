...
$(document).ready(function () {
    ...
    var ChineseScore1 = localStorage.getItem("ChineseScore");
    var ScienceScore1 = localStorage.getItem("ScienceScore");
    var MathScore1 = localStorage.getItem("MathScore");
    var Health2 = 100;
